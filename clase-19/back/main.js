...
// Rutas API de chat: reciben preguntas del frontend y responden con respuestas generadas por el modelo de lenguaje de NVIDIA.
import ChatRoutesApi from "./api/routes/chat.routes.js"
// Rutas API de libros: devuelven el listado de libros desde la base de datos "AH20232CP1".
import LibrosRoutesApi from "./api/routes/libros.routes.js"


// Rutas API de usuarios: registro (POST /api/) y login (POST /api/login)
