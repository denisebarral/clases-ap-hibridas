...
// GET /productos/editar/:id → muestra el formulario pre-rellenado para editar un producto existente
route.get("/productos/editar/:id", productsController.editProductForm)

// POST /productos/editar/:id → recibe los datos del formulario y guarda los cambios en el archivo
route.post("/productos/editar/:id", productsController.productEdit)

// GET /productos/borrar/:id → muestra la página de confirmación antes de borrar el producto
route.get("/productos/borrar/:id", productsController.deleteProductform)

// POST /productos/borrar/:id → ejecuta el borrado y redirige al listado
route.post("/productos/borrar/:id", productsController.productDelete)
