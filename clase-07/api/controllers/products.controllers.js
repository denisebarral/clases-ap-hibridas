...
export function borrarProducto(req, res) {
    ...
    service.deleteProduct(id)
        .then((producto) => {
            // El service devuelve {} si no encontró el producto con ese id
