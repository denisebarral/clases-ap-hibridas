 ...
 * Maneja los mismos estados que Home: carga, error y datos.
 */
...
const Detalle = () => {
    ...
    // useParams() lee los segmentos dinámicos de la URL actual.
    // En el router está definida la ruta como "/detalle/:idPersonaje",
    // así que useParams() devuelve { idPersonaje: "el-valor-de-la-url" }.
    // Si la URL es /detalle/826, entonces idPersonaje === "826".
    ...
    // Si el usuario navegara entre detalles sin salir (ej: botones siguiente/anterior),
    // habría que poner [idPersonaje] como dependencia para re-fetchear al cambiar el ID.
    useEffect(() => {
        ...
        <div className="card mb-3 p-1 border-0" >
            <div className="row g-0">
                ...
                <div className="col-md-8">
                    ...
                    <div>
                        {/* Link navega sin recargar la página, volviendo al listado */}
