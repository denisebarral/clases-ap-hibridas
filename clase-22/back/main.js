...
// Importo el módulo de CORS para permitir solicitudes desde otros orígenes (dominios)
...
// Importo dotenv para cargar variables de entorno desde el archivo .env. Esto es necesario para manejar la clave secreta de JWT sin exponerla en el código fuente.
// dotenv lee el archivo .env de la raíz del proyecto y carga cada variable en process.env.
// A partir de esta línea, cualquier código puede acceder a process.env.SECRET_PASSWORD, etc.
...
import ChatRoutesApi from "./api/routes/chat.routes.js"
...
// Habilito CORS para permitir solicitudes desde otros orígenes (dominios)
app.use(cors())
