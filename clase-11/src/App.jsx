...
const App = () => {
  ...
  return (
    // Fragment vacío (<> </>) agrupa varios elementos sin agregar un nodo extra al DOM.
    // JSX obliga a devolver UN solo elemento raíz; el Fragment es la solución
    // cuando no queremos meter un <div> innecesario solo para cumplir esa regla.
    <>
      <ul>
