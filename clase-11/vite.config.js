...
export default defineConfig({
  plugins: [
    ...
    // React Compiler (experimental en 2025): optimiza automáticamente las
    // re-renderizaciones. Hace lo que antes se hacía a mano con useMemo y
    // useCallback. No cambia el comportamiento: solo lo hace más eficiente.
